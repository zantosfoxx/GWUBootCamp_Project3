 ...
 /*===============================
    ...
    //============== US Downgrade (Downgrade)             30-Mar-11     03-Oct-11
      ...
      //============== Bar plot of US Stock market decline========
       var trace1 = {
        x: [
        `Global Fiancial Crisis <br> <hr> 09-Oct-07 to 09-Mar-09`,
        `US Downgrade <br> <hr> 30-Mar-11 to 03-Oct-11`,
        `Global Slow down fears <br> <hr> 22-May-15 to 25-Aug-15`,
        `Oil, US recession fears <br> <hr> 04-Nov-15 to 11-Feb-16`,
        `Covid-19 concerns <br> <hr> 19-Feb-20 to 23-Mar-20`,
        `Your Investment Period <br> <hr> ${start_date2} to ${end_date}`
      ],
